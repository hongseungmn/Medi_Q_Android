...
public class TabFragmentNutrient extends Fragment implements DialogInterface.OnDismissListener, View.OnClickListener {
    private TabFragmentNutrientCustomDialog customDialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ranking_tab_nutrient, container, false);
        originalLayout = rootView.findViewById(R.id.ranking_nutrient_list);
        textView = rootView.findViewById(R.id.choose_nutrient);
        getFoodList();
    ...
    private void getFoodList() {
        ...
        Single<List<FoodListDTO>> foodListSingle = repository.getFoodListByNutrient(textView.getText().toString());
        ...
        foodListSingle.subscribe(
                foodList -> {
                    ...
                    for (FoodListDTO food : foodList) {
                        ...
                        LinearLayout clonedLayout = new LinearLayout(getContext());
