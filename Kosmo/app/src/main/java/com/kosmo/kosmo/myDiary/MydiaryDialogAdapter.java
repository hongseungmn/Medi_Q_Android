...
public class MydiaryDialogAdapter extends RecyclerView.Adapter<MydiaryDialogAdapter.ViewHolder> implements View.OnClickListener {
    @NonNull
    @Override
    public MydiaryDialogAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.report_type_recyclerview, parent, false);

        return new MydiaryDialogAdapter.ViewHolder(view);
    }

    public MydiaryDialogAdapter(String[] localDataSet) {
        this.localDataSet = localDataSet;
    }

    @Override
    public void onBindViewHolder(@NonNull MydiaryDialogAdapter.ViewHolder holder, int position) {
