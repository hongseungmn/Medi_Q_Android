...
public class AutoCompleteResultRecyclerAdapter extends RecyclerView.Adapter<AutoCompleteResultRecyclerAdapter.ViewHolder> {
    ...
    public AutoCompleteResultRecyclerAdapter(Context context) {
